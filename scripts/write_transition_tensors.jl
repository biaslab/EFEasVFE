...
function write_all_tensors(grid_size)
    ...
    door_transition_tensor = get_door_state_transition_tensor(grid_size)
    ...
    key_transition_tensor = get_key_state_transition_tensor(grid_size)
    ...
    npzwrite("data/raw_tensors/grid_size$(grid_size)/door_transition_tensor.npy", door_transition_tensor)
    ...
    npzwrite("data/raw_tensors/grid_size$(grid_size)/key_transition_tensor.npy", key_transition_tensor)
end
